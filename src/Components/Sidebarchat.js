...
function Sidebarchat({ id, name, addNewChat }) {
  ...
  return !addNewChat ? (
    <div className="sidebar-chat flex p-5 cursor-pointer border-b border-solid border-black border-2 hover:bg-[#ebebeb]">
      <Avatar
        src={`https://api.dicebear.com/7.x/adventurer/svg?seed=${image}`}
        alt="avatar"
      />
      <div className="sidebarchat-info ml-4 text-[#FFFFFF] hover:text-black">
    ...
    <div
      onClick={createChat}
      className="sidebar-chat flex p-5 cursor-pointer border-b border-solid border-black text-[#FFFFFF] hover:text-black hover:bg-[#ebebeb]"
    >
